...
export const aboutStyles = {
  ...
  card: {
    ...
    textContainer: 'w-full lg:w-[45%]', // Уменьшенная ширина текстового блока
    ...
    content: [
      ...
      'max-w-[645px]',    // Максимальная ширина
    ...
    imageContainer: [
      'w-full',
      'lg:w-[50%]' // Увеличенная ширина контейнера изображения
    ].join(' '),
  ...
  forWhom: {
    ...
    content: [
      ...
      'max-w-[994px]',   // Максимальная ширина
